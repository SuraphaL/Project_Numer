...
class CompositeTrapezoidal extends Component {
    ...
    summationX2(n, h, a) {
        ...
        for (var i = 1; i < n; i++) { //วิ่งตามช่วง
            sum += this.func(counter) //เอาไปแทน
            counterhy[i] = this.func(counter);
            counter += h
        }
        console.log(sum);
        return sum
    ...
    render() {
        ...
        return (
            <div >
                <h2 style={{ marginTop: '24px', marginLeft: '30px', color: "black", fontWeight: "bold", fontSize: '24px' }}>Composite Trapzoidal</h2>
                ...
                >
                    <Tabs defaultActiveKey="1" onChange={callback}>
                        ...
                        <TabPane tab="Insert By Database" key="2">
                            <Row>
                                <Col style={{ width: 400 }} span={12}>
                                    <Card style={{ width: 350, padding: '3px', background: '#5cdbd3' }} title="Eqation from Database" bordered={false}>
                                        <h2>Equation</h2>

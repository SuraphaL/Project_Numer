...
class Forwardh extends Component {
    ...
    forwardh(x, h, x1) {
        ...
        y1 = (this.func(x + (1 * h)) - this.func(x)) / h //e^x = e^(2+(1*0.25))-e^(2)
        y1 = y1.toFixed(6);


        y2 = (this.func(x + (2 * h)) - 2 * this.func(x + (1 * h)) + this.func(x)) / Math.pow(h, 2)
        y2 = y2.toFixed(6);


        y3 = (this.func(x + (3 * h)) - 3 * this.func(x + (2 * h)) + 3 * this.func(x + (1 * h)) - this.func(x)) / Math.pow(h, 3)
        y3 = y3.toFixed(6);
    ...
    */
    ...
    render() {
        ...
        return (
            <div >
                <h2 style={{ marginTop: '24px', marginLeft: '30px', color: "black", fontWeight: "bold", fontSize: '24px' }}>Forward Divided-Differences Oh</h2>

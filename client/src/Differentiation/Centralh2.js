...
class Centralh2 extends Component {
    ...
    forwardh(x, h, x1) {
        ...
        y1 = (this.func(x + (1 * h)) - this.func(x - (1 * h))) / (2 * h)
        y1 = y1.toFixed(6);


        y2 = (this.func(x + (1 * h)) - 2 * this.func(x) + this.func(x - (1 * h))) / Math.pow(h, 2)
        y2 = y2.toFixed(6);


        y3 = (this.func(x + (2 * h)) - 2 * this.func(x + (1 * h)) + 2 * this.func(x - (1 * h)) - this.func(x - (2 * h))) / (2 * Math.pow(h, 3))
        y3 = y3.toFixed(6);

        y4 = (this.func(x + (4 * h)) - 4 * this.func(x + (3 * h)) + 6 * this.func(x + (2 * h)) - 4 * this.func(x + (1 * h)) + this.func(x)) / Math.pow(h, 4)
        y4 = y4.toFixed(6);
    ...
    */
    ...
    render() {
        ...
        return (
            <div >
            <h2 style={{ marginTop: '24px', marginLeft: '30px', color: "black", fontWeight: "bold", fontSize: '24px' }}>Central Divided Differences Oh<sup>2</sup></h2>

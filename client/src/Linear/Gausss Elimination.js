...
*/
    ...
    render() {
        ...
        return (
            <div >
                <h2 style={{ marginTop: '24px', marginLeft: '30px', color: "black", fontWeight: "bold", fontSize: '24px' }}>Gauss Elimination</h2>
                ...
                >
                    <Tabs defaultActiveKey="1" onChange={callback}>
                        ...
                        <TabPane tab="Insert By Database" key="2">
                            <Row>
                                <Col style={{ width: 400 }} span={12}>
                                    <Card style={{ width: 350, padding: '3px', background: '#b5f5ec' }} title="Eqation from Database" bordered={false}>
                                        {
                                            //ส่วนแสดงตอนกรอกmatrix

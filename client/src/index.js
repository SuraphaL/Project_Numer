    ...
    return (
      <Layout style={{ height: '100vh' }}>
        ...
        <Layout  >
          ...
          <Layout>
            <Content style={{ height: "100%", backgroundColor: '#fff1b8' }}>
              <div id="content">
                <div style={{marginLeft:30 ,marginTop:20,  /*background: '#ECECEC' */ }}>
                  <Row gutter={16}>
                    <Col span={8}>
                      <Card style={{ width: 300 ,paddingLeft:'3px' }} title="LESSON ONE" bordered={false}>
                    ...
                    <Col span={8}>
                      <Card style={{ width: 300, paddingLeft: "3px" }} title="LESSON TWO" bordered={false}>
                        <img style={{/* background: '#ECECEC',*/ width: 250 }}
                          alt="example"
                          src={linears}
                        />
                    ...
                    <Col span={8}>
                      <Card style={{ width: 300, paddingLeft: "3px" }} title="LESSON THREE" bordered={false}>
                        <img style={{/* background: '#ECECEC',*/ width: 250 }}
                          alt="example"
                          src={inters}
                        />
                ...
                <div style={{ marginLeft:30/*background: '#ECECEC' */ }}>
                  <Row gutter={16}>
                    <Col span={8}>
